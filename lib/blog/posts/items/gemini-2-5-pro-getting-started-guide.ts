...
const postGemini25ProGettingStartedGuide: BlogPost = {
    ...
    title: {
      ...
      cn: 'Gemini 2.5 Pro 新手上手：搜索、创作与分析',
      tw: 'Gemini 2.5 Pro 新手上手：搜尋、創作與分析',
    ...
    excerpt: {
      en: 'Gemini 2.5 Pro guide for general user readers: frameworks, trade-offs, and practical execution steps.',
      cn: '面向General User读者的 Gemini 2.5 Pro 实操指南：框架、取舍与可执行步骤。',
      tw: '面向General User讀者的 Gemini 2.5 Pro 實作指南：框架、取捨與可執行步驟。',
...
Use this playbook to ship safer and faster.`,
      cn: `# Gemini 2.5 Pro Beginner Guide: Search, Create, and Analyze
...
按该框架推进，可以更快且更稳地上线。`,
      tw: `# Gemini 2.5 Pro Beginner Guide: Search, Create, and Analyze
