...
const postGemini25ProMultimodalConversionOptimization: BlogPost = {
    ...
    title: {
      en: 'Gemini 2.5 Pro for Multimodal Conversion Optimization',
      cn: 'Gemini 2.5 Pro 多模态转化优化方法论',
      tw: 'Gemini 2.5 Pro 多模態轉化優化方法論',
      de: 'Gemini 2.5 Pro: Praxisleitfaden 2026',
      es: 'Gemini 2.5 Pro: guía práctica 2026',
      fr: 'Gemini 2.5 Pro : guide pratique 2026',
      jp: 'Gemini 2.5 Pro 実践ガイド 2026',
      pt: 'Gemini 2.5 Pro: guia prático 2026',
      ru: 'Gemini 2.5 Pro: практическое руководство 2026',
    },
    excerpt: {
      en: 'Gemini 2.5 Pro guide for product & ops readers: frameworks, trade-offs, and practical execution steps.',
      cn: '面向Product & Ops读者的 Gemini 2.5 Pro 实操指南：框架、取舍与可执行步骤。',
      tw: '面向Product & Ops讀者的 Gemini 2.5 Pro 實作指南：框架、取捨與可執行步驟。',
      de: 'Gemini 2.5 Pro-Leitfaden mit Frameworks, Trade-offs und konkreten Umsetzungsschritten.',
      es: 'Guía de Gemini 2.5 Pro con framework, trade-offs y pasos de ejecución accionables.',
      fr: 'Guide Gemini 2.5 Pro avec framework, compromis et étapes d’exécution concrètes.',
      jp: 'Gemini 2.5 Pro の実践ガイド。フレームワーク、トレードオフ、実行手順を整理。',
      pt: 'Guia de Gemini 2.5 Pro com framework, trade-offs e passos práticos de execução.',
      ru: 'Практический гайд по Gemini 2.5 Pro: фреймворк, компромиссы и шаги внедрения.',
    },
    content: {
      en: `# Gemini 2.5 Pro for Multimodal Conversion Optimization
...
Use this playbook to ship safer and faster.`,
      cn: `# Gemini 2.5 Pro for Multimodal Conversion Optimization
...
按该框架推进，可以更快且更稳地上线。`,
      tw: `# Gemini 2.5 Pro for Multimodal Conversion Optimization
