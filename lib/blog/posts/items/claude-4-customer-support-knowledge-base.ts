...
const postClaude4CustomerSupportKnowledgeBase: BlogPost = {
    ...
    title: {
      ...
      cn: 'Claude 4 客服与知识库落地指南',
      tw: 'Claude 4 客服與知識庫落地指南',
      de: 'Claude 4: Praxisleitfaden 2026',
      es: 'Claude 4: guía práctica 2026',
      fr: 'Claude 4 : guide pratique 2026',
      jp: 'Claude 4 実践ガイド 2026',
      pt: 'Claude 4: guia prático 2026',
      ru: 'Claude 4: практическое руководство 2026',
    },
    excerpt: {
      en: 'Claude 4 guide for product & ops readers: frameworks, trade-offs, and practical execution steps.',
      cn: '面向Product & Ops读者的 Claude 4 实操指南：框架、取舍与可执行步骤。',
      tw: '面向Product & Ops讀者的 Claude 4 實作指南：框架、取捨與可執行步驟。',
      de: 'Claude 4-Leitfaden mit Frameworks, Trade-offs und konkreten Umsetzungsschritten.',
      es: 'Guía de Claude 4 con framework, trade-offs y pasos de ejecución accionables.',
      fr: 'Guide Claude 4 avec framework, compromis et étapes d’exécution concrètes.',
      jp: 'Claude 4 の実践ガイド。フレームワーク、トレードオフ、実行手順を整理。',
      pt: 'Guia de Claude 4 com framework, trade-offs e passos práticos de execução.',
      ru: 'Практический гайд по Claude 4: фреймворк, компромиссы и шаги внедрения.',
    },
    content: {
      en: `# Claude 4 for Customer Support and Knowledge Base Workflows
...
Use this playbook to ship safer and faster.`,
      cn: `# Claude 4 for Customer Support and Knowledge Base Workflows
...
按该框架推进，可以更快且更稳地上线。`,
      tw: `# Claude 4 for Customer Support and Knowledge Base Workflows
...
Такой подход ускоряет запуск и снижает операционные риски.`,
    ...
    tags: ['Claude 4', 'Customer Support', 'Knowledge Base'],
  };
