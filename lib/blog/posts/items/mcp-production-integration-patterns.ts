...
const postMcpProductionIntegrationPatterns: BlogPost = {
    ...
    title: {
      ...
      cn: 'MCP 生产落地指南：可扩展集成模式',
      tw: 'MCP 生產落地指南：可擴展整合模式',
      de: 'MCP: Praxisleitfaden 2026',
      es: 'MCP: guía práctica 2026',
      fr: 'MCP : guide pratique 2026',
      jp: 'MCP 実践ガイド 2026',
      pt: 'MCP: guia prático 2026',
      ru: 'MCP: практическое руководство 2026',
    },
    excerpt: {
      en: 'MCP guide for developer readers: frameworks, trade-offs, and practical execution steps.',
      cn: '面向Developer读者的 MCP 实操指南：框架、取舍与可执行步骤。',
      tw: '面向Developer讀者的 MCP 實作指南：框架、取捨與可執行步驟。',
      de: 'MCP-Leitfaden mit Frameworks, Trade-offs und konkreten Umsetzungsschritten.',
      es: 'Guía de MCP con framework, trade-offs y pasos de ejecución accionables.',
      fr: 'Guide MCP avec framework, compromis et étapes d’exécution concrètes.',
      jp: 'MCP の実践ガイド。フレームワーク、トレードオフ、実行手順を整理。',
      pt: 'Guia de MCP com framework, trade-offs e passos práticos de execução.',
      ru: 'Практический гайд по MCP: фреймворк, компромиссы и шаги внедрения.',
    },
    content: {
      en: `# MCP in Production: Integration Patterns That Scale
...
Use this playbook to ship safer and faster.`,
      cn: `# MCP in Production: Integration Patterns That Scale
...
按该框架推进，可以更快且更稳地上线。`,
      tw: `# MCP in Production: Integration Patterns That Scale
