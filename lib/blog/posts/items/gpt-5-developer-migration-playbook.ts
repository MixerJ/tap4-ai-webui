...
const postGpt5DeveloperMigrationPlaybook: BlogPost = {
    ...
    excerpt: {
      en: 'GPT-5 guide for developer readers: frameworks, trade-offs, and practical execution steps.',
      cn: '面向Developer读者的 GPT-5 实操指南：框架、取舍与可执行步骤。',
      tw: '面向Developer讀者的 GPT-5 實作指南：框架、取捨與可執行步驟。',
...
Use this playbook to ship safer and faster.`,
      cn: `# GPT-5 Migration Playbook for Developers in 2026
...
按该框架推进，可以更快且更稳地上线。`,
      tw: `# GPT-5 Migration Playbook for Developers in 2026
