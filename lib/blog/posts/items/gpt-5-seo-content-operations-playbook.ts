...
const postGpt5SeoContentOperationsPlaybook: BlogPost = {
    ...
    title: {
      en: 'GPT-5 for SEO and Content Ops: 2026 Playbook',
    ...
    excerpt: {
      en: 'GPT-5 guide for product & ops readers: frameworks, trade-offs, and practical execution steps.',
      cn: '面向Product & Ops读者的 GPT-5 实操指南：框架、取舍与可执行步骤。',
      tw: '面向Product & Ops讀者的 GPT-5 實作指南：框架、取捨與可執行步驟。',
...
Use this playbook to ship safer and faster.`,
      cn: `# GPT-5 for SEO and Content Ops: 2026 Playbook
...
按该框架推进，可以更快且更稳地上线。`,
      tw: `# GPT-5 for SEO and Content Ops: 2026 Playbook
