...
const postClaude4VsGpt5NonTechnicalGuide: BlogPost = {
    ...
    title: {
      en: 'Claude 4 vs GPT-5: Non-Technical Decision Guide',
      cn: 'Claude 4 vs GPT-5：非技术用户决策指南',
      tw: 'Claude 4 vs GPT-5：非技術使用者決策指南',
      de: 'Claude 4 vs GPT-5: Praxisleitfaden 2026',
      es: 'Claude 4 vs GPT-5: guía práctica 2026',
      fr: 'Claude 4 vs GPT-5 : guide pratique 2026',
      jp: 'Claude 4 vs GPT-5 実践ガイド 2026',
      pt: 'Claude 4 vs GPT-5: guia prático 2026',
      ru: 'Claude 4 vs GPT-5: практическое руководство 2026',
    },
    excerpt: {
      en: 'Claude 4 vs GPT-5 guide for general user readers: frameworks, trade-offs, and practical execution steps.',
      cn: '面向General User读者的 Claude 4 vs GPT-5 实操指南：框架、取舍与可执行步骤。',
      tw: '面向General User讀者的 Claude 4 vs GPT-5 實作指南：框架、取捨與可執行步驟。',
      de: 'Claude 4 vs GPT-5-Leitfaden mit Frameworks, Trade-offs und konkreten Umsetzungsschritten.',
      es: 'Guía de Claude 4 vs GPT-5 con framework, trade-offs y pasos de ejecución accionables.',
      fr: 'Guide Claude 4 vs GPT-5 avec framework, compromis et étapes d’exécution concrètes.',
      jp: 'Claude 4 vs GPT-5 の実践ガイド。フレームワーク、トレードオフ、実行手順を整理。',
      pt: 'Guia de Claude 4 vs GPT-5 com framework, trade-offs e passos práticos de execução.',
      ru: 'Практический гайд по Claude 4 vs GPT-5: фреймворк, компромиссы и шаги внедрения.',
    },
    content: {
      en: `# Claude 4 vs GPT-5: Non-Technical Decision Guide
...
Use this playbook to ship safer and faster.`,
      cn: `# Claude 4 vs GPT-5: Non-Technical Decision Guide
...
按该框架推进，可以更快且更稳地上线。`,
      tw: `# Claude 4 vs GPT-5: Non-Technical Decision Guide
