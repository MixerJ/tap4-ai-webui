...
const postGemini25ProMultimodalDevWorkflows: BlogPost = {
    ...
    title: {
      ...
      cn: 'Gemini 2.5 Pro 全栈实践：多模态开发工作流',
      tw: 'Gemini 2.5 Pro 全端實戰：多模態開發工作流',
    ...
    excerpt: {
      en: 'Gemini 2.5 Pro guide for developer readers: frameworks, trade-offs, and practical execution steps.',
      cn: '面向Developer读者的 Gemini 2.5 Pro 实操指南：框架、取舍与可执行步骤。',
      tw: '面向Developer讀者的 Gemini 2.5 Pro 實作指南：框架、取捨與可執行步驟。',
...
Use this playbook to ship safer and faster.`,
      cn: `# Gemini 2.5 Pro for Full-Stack Teams: Multimodal Workflow Guide
...
按该框架推进，可以更快且更稳地上线。`,
      tw: `# Gemini 2.5 Pro for Full-Stack Teams: Multimodal Workflow Guide
