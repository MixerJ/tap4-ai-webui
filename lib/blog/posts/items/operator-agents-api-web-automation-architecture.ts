...
const postOperatorAgentsApiWebAutomationArchitecture: BlogPost = {
    ...
    excerpt: {
      en: 'AI Agents guide for developer readers: frameworks, trade-offs, and practical execution steps.',
      cn: '面向Developer读者的 AI Agents 实操指南：框架、取舍与可执行步骤。',
      tw: '面向Developer讀者的 AI Agents 實作指南：框架、取捨與可執行步驟。',
...
Use this playbook to ship safer and faster.`,
      cn: `# Building Reliable Web Automation with Operator-Style Agents APIs
...
按该框架推进，可以更快且更稳地上线。`,
      tw: `# Building Reliable Web Automation with Operator-Style Agents APIs
