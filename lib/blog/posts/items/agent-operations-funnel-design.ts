...
const postAgentOperationsFunnelDesign: BlogPost = {
    ...
    title: {
      ...
      de: 'AI Agents: Praxisleitfaden 2026',
      es: 'AI Agents: guía práctica 2026',
      fr: 'AI Agents : guide pratique 2026',
      jp: 'AI Agents 実践ガイド 2026',
      pt: 'AI Agents: guia prático 2026',
      ru: 'AI Agents: практическое руководство 2026',
    },
    excerpt: {
      en: 'AI Agents guide for product & ops readers: frameworks, trade-offs, and practical execution steps.',
      cn: '面向Product & Ops读者的 AI Agents 实操指南：框架、取舍与可执行步骤。',
      tw: '面向Product & Ops讀者的 AI Agents 實作指南：框架、取捨與可執行步驟。',
      de: 'AI Agents-Leitfaden mit Frameworks, Trade-offs und konkreten Umsetzungsschritten.',
      es: 'Guía de AI Agents con framework, trade-offs y pasos de ejecución accionables.',
      fr: 'Guide AI Agents avec framework, compromis et étapes d’exécution concrètes.',
      jp: 'AI Agents の実践ガイド。フレームワーク、トレードオフ、実行手順を整理。',
      pt: 'Guia de AI Agents com framework, trade-offs e passos práticos de execução.',
      ru: 'Практический гайд по AI Agents: фреймворк, компромиссы и шаги внедрения.',
    },
    content: {
      en: `# Agent-Driven Operations: Designing an Observable Automation Funnel
...
Use this playbook to ship safer and faster.`,
      cn: `# Agent-Driven Operations: Designing an Observable Automation Funnel
...
按该框架推进，可以更快且更稳地上线。`,
      tw: `# Agent-Driven Operations: Designing an Observable Automation Funnel
