...
const postMcpExplainedForEverydayUsers: BlogPost = {
    ...
    excerpt: {
      en: 'MCP guide for general user readers: frameworks, trade-offs, and practical execution steps.',
      cn: '面向General User读者的 MCP 实操指南：框架、取舍与可执行步骤。',
      tw: '面向General User讀者的 MCP 實作指南：框架、取捨與可執行步驟。',
...
Use this playbook to ship safer and faster.`,
      cn: `# MCP Explained Simply: Why It Matters for Everyday AI Tools
...
按该框架推进，可以更快且更稳地上线。`,
      tw: `# MCP Explained Simply: Why It Matters for Everyday AI Tools
