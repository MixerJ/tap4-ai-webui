# 开源Toolsify AI Web UI

这是一个由[Toolsify AI工具导航站](https://toolsify.ai)开源的AI导航站项目。我们的目标是让大家很容易就拥有一个属于自己的AI导航站，
收录自己喜欢的AI工具产品。这个项目非常轻量级，维护简单，适合对AI导航站感兴趣的个人开发者，也适合对NextJs有兴趣的学习者，
欢迎大家fork和star。

[English](https://github.com/6677-ai/toolsify-ai-webui/blob/main/README.md) | 简体中文

## 请在Product Hunt支持下Toolsify AI
...
- 对接Toolsify AI爬虫项目，支持提交和收录全自动
- 支持简易的分类和搜索

注：如果你对数据库不熟悉，或者担心和v1.0.0版本的兼容问题，请点击切
到[v1.0.0分支](https://github.com/6677-ai/toolsify-ai-webui/tree/v1.0.0)。
...
![tai4-ai](./public/images/toolsifyai.zh-CN.png)

## 感谢关注链接

欢迎关注我们的Twitter: https://x.com/toolsifyai
...
如果你对项目有兴趣，欢迎添加我微信: helloleo2023, 备注: "toolsify ai开源"，也可以扫描二维码:
![toolsify-ai-wx](./public/images/toolsify-ai-wechat.jpg)

## 部署说明

### 部署Toolsify AI Crawler

具体见[Toolsify AI Crawler](https://github.com/6677-ai/toolsify-ai-crawler) 部署完成后，可以使用平台提供的域名或者自定义域名，作
...
问：[Toolsify AI](https://toolsify.ai)
...
访问：: [6677-ai/toolsify-ai-crawler](https://github.com/6677-ai/toolsify-ai-crawler)
