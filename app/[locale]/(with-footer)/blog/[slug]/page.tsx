...
export default async function BlogPostPage({ params: { locale, slug } }: { params: { locale: string; slug: string } }) {
  ...
  const articleMiddleAdSlot = AD_SLOTS.blog.articleMiddle || AD_SLOTS.blog.inFeed;
  ...
  return (
    <div className='relative min-h-screen w-full'>
      ...
      <div className='relative mx-auto w-full max-w-[1320px] px-5 py-10 lg:px-6 lg:py-16'>
        {/* 返回链接 */}
        <Link
          href='/blog'
        ...
        <div className='grid grid-cols-1 gap-8 lg:grid-cols-[minmax(0,1fr)_320px] lg:items-start'>
          {/* 文章内容 */}
          <article className='rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm lg:p-10'>
            {/* 文章元信息 */}
